// <copyright file="ConcordInterviewClient.cs" company="APIMatic">
// Copyright (c) APIMatic. All rights reserved.
// </copyright>
namespace ConcordInterview.Standard
{
    using System;
    ...
    /// </summary>
    public sealed class ConcordInterviewClient : IConfiguration
    {
        ...
        {
            {
                ...
                {
                    { Server.Server1, "https://concord-test.herokuapp.com/api" },
                }
            },
        };
        ...
        private ConcordInterviewClient(
        ...
        /// <summary>
        /// Creates an object of the ConcordInterviewClient using the values provided for the builder.
        /// </summary>
        ...
        /// </summary>
        /// <returns> ConcordInterviewClient.</returns>
        internal static ConcordInterviewClient CreateFromEnvironment()
        {
            var builder = new Builder();

            string environment = System.Environment.GetEnvironmentVariable("CONCORD_INTERVIEW_STANDARD_ENVIRONMENT");
        ...
        {
            private Environment environment = ConcordInterview.Standard.Environment.Production;
            ...
            /// </summary>
            /// <returns>ConcordInterviewClient.</returns>
            public ConcordInterviewClient Build()
            {
                this.httpClient = new HttpClientWrapper(this.httpClientConfig.Build());

                return new ConcordInterviewClient(
                    this.environment,
                    this.authManagers,
                    this.httpClient,
                    this.httpCallBack,
